...
- [Deploy your app to cloud](https://docs.langchain.com/langsmith/deployment-quickstart.md): Deploy your first application to LangSmith Cloud using the LangGraph CLI.
...
- [Self-host LangSmith with Docker (Deprecated)](https://docs.langchain.com/langsmith/docker.md): Docker-based self-hosting for LangSmith is deprecated. Use Kubernetes powered infrastructure instead.
...
- [Pricing FAQ](https://docs.langchain.com/langsmith/fleet/pricing-faq.md)
...
- [Manage Fleet](https://docs.langchain.com/langsmith/fleet/self-hosted.md)
- [Self-hosted Fleet](https://docs.langchain.com/langsmith/fleet/self-hosted-link.md)
- [Workspace setup](https://docs.langchain.com/langsmith/fleet/setup.md): Add required workspace secrets for models and tools used by Fleet.
...
- [Manage a trace](https://docs.langchain.com/langsmith/manage-trace.md): Compare traces side-by-side, share traces publicly, and view server logs from the trace view in LangSmith.
...
- [Sandbox templates](https://docs.langchain.com/langsmith/sandbox-templates.md): Define container images, resource limits, and configuration for sandboxes using templates.
- [Sandbox warm pools](https://docs.langchain.com/langsmith/sandbox-warm-pools.md): Pre-provision sandboxes for faster execution with automatic replenishment.
